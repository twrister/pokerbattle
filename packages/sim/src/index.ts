...
export {
  ...
  BOMB_ARC_SCALE,
  FUSE_BOMB_MIN_FLIGHT_SECONDS,
  GIANT_BOMB_ARC_SCALE,
  GROUND_PROJECTILE_HEIGHT,
  PROJECTILE_ARC_MAX,
  PROJECTILE_ARC_MIN,
  PROJECTILE_ARC_RATIO,
  arcApexForDistance,
  fuseBombFlightSpeed,
...
export {
  ...
  type DeathSpawnEntry,
  type DeathSpawnEntryDraft,
  type DetonateConfig,
